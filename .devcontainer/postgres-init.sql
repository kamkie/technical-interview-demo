...
ON
DATABASE
technical_interview_demo TO demo_user;

-- Connect to the technical_interview_demo database
\c
technical_interview_demo

-- Create schema and grant privileges
GRANT ALL PRIVILEGES ON SCHEMA public TO demo_user;
GRANT ALL PRIVILEGES ON ALL
TABLES IN SCHEMA public TO demo_user;
GRANT ALL PRIVILEGES ON ALL
SEQUENCES IN SCHEMA public TO demo_user;
GRANT ALL PRIVILEGES ON ALL
FUNCTIONS IN SCHEMA public TO demo_user;

-- Allow the user to create tables (for Flyway migrations)
ALTER
DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL PRIVILEGES ON TABLES TO demo_user;
ALTER
DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL PRIVILEGES ON SEQUENCES TO demo_user;
ALTER
DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL PRIVILEGES ON FUNCTIONS TO demo_user;
