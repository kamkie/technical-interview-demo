...
echo "  3. Generate docs: ./gradlew asciidoctor"
...
echo "  • ./gradlew checkFormat      - Check code formatting"
echo "  • ./gradlew pmdMain          - Run PMD analysis"
echo "  • ./gradlew asciidoctor      - Generate API documentation"
echo "  • ./gradlew dockerBuild      - Build Docker image"
echo ""
