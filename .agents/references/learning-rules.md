...
It does not store the lessons themselves; `docs/LEARNINGS.md` stores approved durable lessons.
...
- **Repo-wide and durable:** add it to `docs/LEARNINGS.md` only when it is recurring, reusable across tasks, and likely to survive refactors.
...
4. Add to `docs/LEARNINGS.md` only when the lesson is repo-wide, recurring, and likely to survive refactors.
...
Do not accumulate per-incident history, one-off mistakes, or temporary workaround notes in `docs/LEARNINGS.md`.

## Cross-References

- `docs/LEARNINGS.md`: durable repo-wide lesson storage.
