...
Use `.agents/references/code-style.md` for edit-shaping rules, `.agents/references/testing.md` for validation scope, and `.agents/references/documentation.md` for contract-artifact alignment.
