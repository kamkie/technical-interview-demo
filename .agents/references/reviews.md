...
`.agents/references/reviews.md` owns standing AI guidance for self-review, code review, and security review in this repository.
...
- contradictory instructions across README, CONTRIBUTING, AGENTS, `docs/`, and `.agents/` docs
...
- use `.agents/references/testing.md` to confirm whether validation scope is sufficient
- use `.agents/references/documentation.md` when the review question is mainly about doc ownership, cross-reference cleanup, or maintainer guidance alignment
