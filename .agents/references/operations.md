...
- Route durable lessons from avoidable operational failures through `.agents/references/learning-rules.md`; store accepted repo-wide lessons in `docs/LEARNINGS.md`.
...
Use `.agents/references/learning-rules.md` to decide whether the lesson should survive the current incident, release, or plan, then update `docs/LEARNINGS.md` only for accepted repo-wide lessons.
...
- `docs/LEARNINGS.md`: durable lesson storage for operational failures or repeated signals.
