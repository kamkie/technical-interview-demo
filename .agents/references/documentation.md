...
- backend-owned contract, external skill references, OpenAPI source reference, and integration guidance for AI agents working in a separate first-party frontend repository: `docs/FRONTEND_AI_CONTRACT.md`
