...
- Commit-message conventions are now owned by `CONTRIBUTING.md` and use Conventional Commits plus project metadata footers; the earlier custom body-line taxonomy is superseded.
