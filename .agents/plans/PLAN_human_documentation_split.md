...
| --- | --- | --- | --- | --- | --- |
| 1: Documentation Spine And AI Guide Move | Not Started | Agent | Pending | Pending | Create human docs index/lifecycle guide and move AI collaboration guide under `docs/`. |
