...
Supersession note: `.agents/plans/PLAN_repository_knowledge_layout_migration.md` moved live AI guidance from the former top-level AI directory into `.agents/`. Remaining old AI-directory and `ai/TASK_LIBRARY.md` references in this implemented plan are historical notes for the completed task-skill migration.
...
- In scope:
  ...
  - update `AGENTS.md`, `.agents/references/documentation.md`, planning/execution guidance, repo-local skills, templates, references, active plans, and `ROADMAP.md` where they still name `ai/TASK_LIBRARY.md`
...
- At planning time, `AGENTS.md`, `.agents/references/documentation.md`, `.agents/references/planning.md`, and `.agents/skills/repo-plan-author/SKILL.md` mentioned `ai/TASK_LIBRARY.md` as the reusable task catalog or task-title source.
- `.agents/plans/PLAN_ai_guidance_execution_prompt_library_restructure.md` records the earlier implemented decision to keep reusable starters in `ai/TASK_LIBRARY.md`; this plan intentionally supersedes that storage decision for live guidance.
- No `.agents/` directory is currently present in the repository. Existing repo-local skills live under `.agents/skills/`.
...
- Live guidance and references to check:
  ...
  - `.agents/references/environment-quick-ref.md`
  - `.agents/templates/**`
  - `.agents/references/**`
  - `.agents/skills/**/SKILL.md`
  - active `.agents/plans/PLAN_*.md`
  - `ROADMAP.md`
...
- owned files or packages: `.agents/skills/repo-task/references/spec.md`, `temp/spec.md`, `AGENTS.md`, `.agents/references/documentation.md`, this plan if execution notes are needed
- shared files reserved to the coordinator: `ROADMAP.md`
- context required before execution: `AGENTS.md`, `.agents/references/execution.md`, this plan, `.agents/references/documentation.md`, and the `skill-creator` guidance
...
- context required before execution: `AGENTS.md`, `.agents/references/execution.md`, this plan, `.agents/skills/repo-task/references/spec.md`, and the `skill-creator` guidance
...
- context required before execution: `AGENTS.md`, `.agents/references/execution.md`, this plan, `.agents/skills/repo-task/references/spec.md`, and `ai/TASK_LIBRARY.md`
...
- owned files or packages: `AGENTS.md`, `WORKING_WITH_AI.md`, top-level `ai/*.md`, `.agents/templates/**`, `.agents/references/**`, `.agents/skills/**/SKILL.md`, active `.agents/plans/PLAN_*.md`, `ROADMAP.md`
- shared files reserved to the coordinator: `AGENTS.md`, `.agents/references/documentation.md`, `ROADMAP.md`
- context required before execution: `AGENTS.md`, `.agents/references/execution.md`, this plan, `.agents/references/documentation.md`, `.agents/references/planning.md`, `.agents/skills/repo-task/references/spec.md`, and the specific files found by targeted searches
...
- context required before execution: `AGENTS.md`, `.agents/references/execution.md`, this plan, `.agents/references/testing.md`, `.agents/skills/repo-task/references/spec.md`
...
- Roadmap tracking: `ROADMAP.md` Planned Work points to `.agents/plans/PLAN_repo_task_skill_migration.md`.
