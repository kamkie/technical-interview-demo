...
Use `AGENTS.md`, `.agents/references/workflow.md`, `.agents/references/execution.md`, `.agents/references/documentation.md`, `.agents/references/testing.md`, and `.agents/references/reviews.md` as coordinator.
...
Fold accepted `CHANGELOG_<topic>.md` entries into `CHANGELOG.md`, update any canonical plan files or shared artifacts the accepted PRs require, clean consumed local worker branches or worktrees under `.agents/references/workflow.md`, and delete consumed private changelog files and worker logs before the final push or PR unless I explicitly want them retained.
