...
Use `.agents/references/plan-execution.md`; add `.agents/references/workflow.md` when the plan requires delegation, worktrees, worker logs, or integration handoff.
