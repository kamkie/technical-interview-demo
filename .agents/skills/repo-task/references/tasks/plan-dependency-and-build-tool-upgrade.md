...
Create `.agents/plans/PLAN_<topic>.md` for this dependency or build-tool upgrade batch:
- <item 1>
- <item 2>

Read `AGENTS.md`, `.agents/references/planning.md`, `.agents/references/documentation.md`, `.agents/references/testing.md`, the relevant build files, and the exact alert, version target, or tool output that motivates the upgrade first.
