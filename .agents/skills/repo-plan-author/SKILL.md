...
description: Create or revise repository-local `.agents/plans/PLAN_*.md` execution plans, lifecycle metadata, milestone breakdowns, and readiness reviews for this repository. Use when asked to plan work, turn roadmap items into a plan, revise an existing plan, review whether a plan is ready, or decide whether work should remain in `Discovery`, move to `Planning`, or wait for more input.
---
...
Use this skill to create or revise plan files without redistributing standing policy out of `.agents/references/planning.md`.
...
- always: `AGENTS.md` and `.agents/references/planning.md`
...
3. If creating a new plan, prefer one coherent `.agents/plans/PLAN_<topic>.md` unless the work is genuinely disjoint.
...
- use the lifecycle vocabulary from `.agents/references/planning.md`; do not invent a parallel scheme
...
- route standing policy back to `.agents/references/planning.md`, `.agents/references/workflow.md`, `.agents/references/documentation.md`, and `.agents/references/testing.md` instead of copying them into the plan
