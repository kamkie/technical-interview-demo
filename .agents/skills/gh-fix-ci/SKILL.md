...
Keep the skill narrow: it is for GitHub Actions PR-check triage and follow-up, not for replacing the standing rules in `AGENTS.md`, `.agents/references/planning.md`, `.agents/references/testing.md`, or `.agents/references/reviews.md`.
...
- if the failure implies contract or documentation drift: `.agents/references/documentation.md` plus the affected contract artifacts
