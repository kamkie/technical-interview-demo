...
- [docs/FRONTEND_AI_CONTRACT.md](docs/FRONTEND_AI_CONTRACT.md): backend-owned contract, external skill references, OpenAPI source reference, and integration rules for AI agents building a separate first-party frontend
...
- [docs/FRONTEND_AI_CONTRACT.md](docs/FRONTEND_AI_CONTRACT.md): source backend contract, external skill references, OpenAPI source reference, and integration constraints for a separate frontend repository's AI agents
