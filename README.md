...
- [docs/FRONTEND_AI_CONTRACT.md](docs/FRONTEND_AI_CONTRACT.md): backend-owned contract, security, OpenAPI snapshot, and design instructions for AI agents building a separate first-party frontend
...
- [docs/FRONTEND_AI_CONTRACT.md](docs/FRONTEND_AI_CONTRACT.md): source backend contract, security guidance, OpenAPI snapshot, and design constraints for a separate frontend repository's AI agents
