...
class OperatorSurfaceApiDocumentationTests extends AbstractDocumentationIntegrationTest {
        ...
        mockMvc.perform(get("/api/operator/surface")
                ...
                .andDo(documentEndpoint(
                        ...
                        relaxedResponseFields(
                                fieldWithPath("audit.auditLogEndpoint").description("Endpoint path for full audit log pagination."),
                                ...
                                fieldWithPath("audit.recentEntries[].targetType").description("Type of audited target."),
                                fieldWithPath("audit.recentEntries[].targetId").description("Identifier of the audited target."),
                                ...
                                fieldWithPath("operations.actuatorInfoEndpoint").description("Endpoint path for build and git metadata."),
                                fieldWithPath("operations.actuatorPrometheusEndpoint").description("Endpoint path for trusted deployment metrics scraping."),
                                fieldWithPath("operations.applicationHealthStatus").description("Current aggregate health status code."),
                                fieldWithPath("operations.livenessState").description("Current Spring Boot liveness state."),
                                fieldWithPath("operations.readinessState").description("Current Spring Boot readiness state.")
                        )
                ));
    }
    ...
    void documentGetOperatorSurfaceUnauthorizedError() throws Exception {
        mockMvc.perform(get("/api/operator/surface"))
                ...
                .andDo(documentEndpoint(
                        "errors/get-operator-surface-unauthorized",
