...
class ApiDocumentationTests extends AbstractDocumentationIntegrationTest {
    ...
    void documentHelloEndpoint() throws Exception {
        mockMvc.perform(get("/hello"))
                ...
                .andDo(documentEndpoint("hello/get-hello", responseHeaders(commonResponseHeaders()), responseBody()));
    }
        ...
        mockMvc.perform(get("/"))
                ...
                .andDo(documentEndpoint(
                        ...
                        relaxedResponseFields(
                                ...
                                fieldWithPath("build.artifact")
                                        .description("Build artifact from generated build metadata."),
                                fieldWithPath("build.version")
                                        .description("Application version derived from the nearest reachable git tag."),
                                fieldWithPath("build.time").description("Build timestamp."),
                                fieldWithPath("git.branch")
                                        .description("Current git branch captured during the build."),
                                fieldWithPath("git.commitId")
                                        .description("Full git commit id captured during the build."),
                                fieldWithPath("git.shortCommitId")
                                        .description("Short git commit id captured during the build."),
                                fieldWithPath("git.commitTime")
                                        .description("Commit timestamp for the captured git revision."),
                                ...
                                fieldWithPath("runtime.activeProfiles")
                                        .description("Currently active Spring profiles."),
                                subsectionWithPath("dependencies")
                                        .description(
                                                "Selected runtime dependency versions for the main technical building"
                                                        + " blocks."),
                                fieldWithPath("configuration.pagination.defaultPageSize")
                                        .description("Default pageable page size."),
                                fieldWithPath("configuration.pagination.maxPageSize")
                                        .description("Maximum pageable page size."),
                                fieldWithPath("configuration.session.storeType")
                                        .description("Configured Spring Session store type."),
                                fieldWithPath("configuration.session.timeout").description("HTTP session timeout."),
                                fieldWithPath("configuration.session.cookieName")
                                        .description("Session cookie name."),
                                fieldWithPath("configuration.session.cookieHttpOnly")
                                        .description("Whether the session cookie is HTTP-only."),
                                fieldWithPath("configuration.session.cookieSameSite")
                                        .description("Session cookie SameSite mode."),
                                fieldWithPath("configuration.observability.exposedEndpoints")
                                        .description("Actuator web endpoints exposed by configuration, including"
                                                + " deployment-scoped endpoints such as Prometheus scraping."),
                                fieldWithPath("configuration.observability.healthProbesEnabled")
                                        .description("Whether readiness/liveness probe groups are enabled."),
                                fieldWithPath("configuration.observability.tracingSamplingProbability")
                                        .description("Tracing sampling probability."),
                                fieldWithPath("configuration.documentation.html")
                                        .description("Bundled HTML documentation entry point."),
                                fieldWithPath("configuration.documentation.openApiJson")
                                        .description("OpenAPI JSON endpoint path."),
                                fieldWithPath("configuration.documentation.openApiYaml")
                                        .description("OpenAPI YAML endpoint path."),
                                fieldWithPath("configuration.documentation.openApiVersion")
                                        .description("Configured OpenAPI document dialect."),
                                fieldWithPath("configuration.security.csrfEnabled")
                                        .description("Whether same-site CSRF protection is enabled for unsafe browser"
                                                + " writes."),
                                fieldWithPath("configuration.security.csrfCookieName")
                                        .description(
                                                "Readable CSRF cookie name mirrored by the separate first-party UI."),
                                fieldWithPath("configuration.security.csrfHeaderName")
                                        .description("Request header name required on unsafe browser writes."),
                                fieldWithPath("configuration.security.oauthProfileActive")
                                        .description("Whether the optional oauth profile is currently active. The base"
                                                + " runtime remains deployable without it."),
                                fieldWithPath("configuration.security.publicApiPathPattern")
                                        .description(
                                                "Documented public path family intended for external exposure through"
                                                        + " the reverse proxy."),
                                fieldWithPath("configuration.security.oauthAuthorizationBasePath")
                                        .description("Base path for same-site OAuth provider authorization bootstrap"
                                                + " endpoints."),
                                fieldWithPath("configuration.security.oauthCallbackPathTemplate")
                                        .description(
                                                "Callback path template expected from the external identity provider"
                                                        + " after proxy forwarding."),
                                fieldWithPath("configuration.security.forwardHeadersStrategy")
                                        .description(
                                                "Configured Spring forwarded-header handling strategy used to honor"
                                                        + " trusted reverse-proxy headers."),
                                fieldWithPath("configuration.security.abuseProtection.owner")
                                        .description(
                                                "Deployment owner for abusive-client controls on login bootstrap and"
                                                        + " unsafe internet-public write paths."),
                                fieldWithPath("configuration.security.abuseProtection.loginBootstrapPathTemplate")
                                        .description(
                                                "Path template whose OAuth login bootstrap traffic requires edge burst"
                                                        + " limiting plus challenge-or-block capability."),
                                fieldWithPath("configuration.security.abuseProtection.loginBootstrapControls")
                                        .description("Minimum edge-owned controls required on the OAuth login bootstrap"
                                                + " path."),
                                fieldWithPath("configuration.security.abuseProtection.unsafeWritePathPattern")
                                        .description("Unsafe request path family whose internet-public traffic requires"
                                                + " edge throttling and request-size enforcement."),
                                fieldWithPath("configuration.security.abuseProtection.unsafeWriteExamples")
                                        .description("Representative unsafe write endpoints covered by the edge-owned"
                                                + " abuse-protection posture."),
                                fieldWithPath("configuration.security.abuseProtection.unsafeWriteControls")
                                        .description("Minimum edge-owned controls required on unsafe internet-public"
                                                + " writes."),
                                fieldWithPath("configuration.shutdown.serverShutdown")
                                        .description("Server shutdown mode."),
                                fieldWithPath("configuration.shutdown.timeoutPerShutdownPhase")
                                        .description("Per-phase graceful shutdown timeout."))));
    }
    ...
    void documentDocsEndpoint() throws Exception {
        mockMvc.perform(get("/docs"))
                ...
                .andDo(documentEndpoint(
                        "docs/get-docs",
                        responseHeaders(commonResponseHeaders(headerWithName("Location")
                                .description("Redirect target for the generated API documentation.")))));
    }
        ...
        mockMvc.perform(get("/api/books")
                ...
                .andDo(documentEndpoint(
                        ...
                        queryParameters(
                                ...
                                parameterWithName("author")
                                        .optional()
                                        .description("Case-insensitive author substring filter."),
                                parameterWithName("isbn").optional().description("Exact or partial ISBN filter."),
                                parameterWithName("category")
                                        .optional()
                                        .description("Repeatable case-insensitive category-name filter. When multiple"
                                                + " values are provided, books that match any requested category"
                                                + " are returned."),
                                parameterWithName("year")
                                        .optional()
                                        .description(
                                                "Exact publication year filter. Cannot be combined with `yearFrom` or"
                                                        + " `yearTo`."),
                                parameterWithName("yearFrom")
                                        .optional()
                                        .description("Inclusive publication year lower bound."),
                                parameterWithName("yearTo")
                                        .optional()
                                        .description("Inclusive publication year upper bound.")),
                        responseHeaders(commonResponseHeaders()),
                        relaxedResponseFields(
                                fieldWithPath("content[].id").description("Book identifier."),
                                fieldWithPath("content[].version")
                                        .description("Optimistic-locking version for the book."),
                                fieldWithPath("content[].title").description("Book title."),
                                fieldWithPath("content[].author").description("Book author."),
                                fieldWithPath("content[].isbn")
                                        .description("Unique ISBN assigned when the book is created."),
                                fieldWithPath("content[].publicationYear").description("Publication year."),
                                fieldWithPath("content[].categories[].id")
                                        .description("Category identifier assigned to the book."),
                                fieldWithPath("content[].categories[].name")
                                        .description("Category name assigned to the book."),
                                ...
                                fieldWithPath("numberOfElements")
                                        .description("Number of books returned in the current page."),
    ...
    void documentListBooksInvalidRequestError() throws Exception {
        mockMvc.perform(get("/api/books").queryParam("year", "2018").queryParam("yearFrom", "2000"))
                ...
                .andDo(documentEndpoint(
                        ...
                        queryParameters(
                                parameterWithName("year")
                                        .description("Exact publication year filter used in the invalid request."),
                                parameterWithName("yearFrom")
                                        .description("Range filter that conflicts with `year` in this example.")),
                        responseHeaders(commonResponseHeaders()),
        ...
        mockMvc.perform(post("/api/books")
                ...
                .andDo(documentEndpoint(
                        ...
                        requestFields(
                                ...
                                fieldWithPath("isbn")
                                        .description("Unique ISBN for the new book, at most 32 characters."),
                        ...
                        responseFields(
                                ...
                                fieldWithPath("version")
                                        .description("Initial optimistic-locking version for the book."),
                                fieldWithPath("title").description("Book title."),
                                fieldWithPath("author").description("Book author."),
        ...
        mockMvc.perform(put("/api/books/{id}", cleanCode.getId())
                ...
                .andDo(documentEndpoint(
                        ...
                        requestFields(
                                ...
                                fieldWithPath("publicationYear")
                                        .description("Updated publication year from 0 through 3000."),
                                fieldWithPath("categories")
                                        .optional()
                        ...
                        responseFields(
                                fieldWithPath("id").description("Book identifier."),
                                fieldWithPath("version")
                                        .description("Incremented optimistic-locking version after the update."),
        ...
        mockMvc.perform(put("/api/books/{id}", cleanCode.getId())
                ...
                .andDo(documentEndpoint(
                        ...
                        pathParameters(parameterWithName("id")
                                .description("Book identifier being updated with an outdated version.")),
                        requestBody(),
                        responseHeaders(commonResponseHeaders()),
                        relaxedResponseFields(problemResponseFields())));
    }
    ...
    void documentGetBookInvalidIdError() throws Exception {
        mockMvc.perform(get("/api/books/{id}", "abc"))
                ...
                .andDo(documentEndpoint(
                        ...
                        pathParameters(parameterWithName("id")
                                .description("Invalid book identifier value used in this example.")),
                        responseHeaders(commonResponseHeaders()),
                        relaxedResponseFields(problemResponseFields())));
    }
    ...
    void documentGetBookNotFoundError() throws Exception {
        mockMvc.perform(get("/api/books/{id}", 9999).queryParam("lang", "es"))
                ...
                .andDo(documentEndpoint(
                        ...
                        queryParameters(parameterWithName("lang")
                                .optional()
                                .description("Optional language override for localized error messages."
                                        + " Browser-style values such as `es` or `es-ES` are accepted.")),
                        responseHeaders(commonResponseHeaders()),
                        relaxedResponseFields(problemResponseFields())));
    }
    ...
    void documentDeleteBookEndpoint() throws Exception {
        mockMvc.perform(delete("/api/books/{id}", cleanCode.getId()).with(readerSession.unsafeWrite()))
                ...
                .andDo(documentEndpoint(
                        ...
                        responseFields(
                                ...
                                fieldWithPath("groups")
                                        .description("Health groups exposed by the actuator endpoint."))));
    }
