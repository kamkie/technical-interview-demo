...
class TechnicalOverviewControllerIntegrationTests extends AbstractMockMvcIntegrationTest {
    ...
    void rootEndpointReturnsTechnicalOverviewWithFrozenRuntimePosture() throws Exception {
        mockMvc.perform(get("/"))
                ...
                .andExpect(jsonPath("$.configuration.security.abuseProtection.owner").value("edge-or-gateway"))
                ...
                .andExpect(jsonPath("$.configuration.security.abuseProtection.unsafeWritePathPattern").value("/api/**"))
