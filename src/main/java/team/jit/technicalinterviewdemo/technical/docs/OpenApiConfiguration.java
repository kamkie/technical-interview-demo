...
public class OpenApiConfiguration {
    ...
    OpenAPI technicalInterviewDemoOpenApi(BuildProperties buildProperties) {
        SecurityScheme sessionCookieSecurityScheme = new SecurityScheme()
                ...
                .description("Authenticated browser session cookie used by protected operations."
                        ...
                        + " is active. Unsafe browser writes also require the " + SameSiteCsrfContract.HEADER_NAME
                        + " request header mirrored from the readable " + SameSiteCsrfContract.COOKIE_NAME
                        + " cookie.");
        ...
        return new OpenAPI()
                .info(new Info()
                        ...
                        .description("Machine-readable contract for the demo application's supported external /api/**"
