 ...
 */
@SuiteName(value = "03-public-book-and-category-reads", requires = {"01-public-overview-and-docs"})
public class Suite03PublicBookAndCategoryReads extends SuiteBase {
    ...
    void listBooksWithPagination_returnsContent() {
        ...
        if (content == null || content.isEmpty()) {
            ...
            recordIdentifier(IDENTIFIER_FIRST_BOOK_ID, String.valueOf(response.jsonPath().get("content[0].id")));
        }
    ...
    void listCategories_returnsContent() {
        Response response = http().send(
                "GET", "/api/categories", http().anonymous(), 200, Optional.of("public category list"));
