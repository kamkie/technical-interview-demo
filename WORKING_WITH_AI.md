...
It summarizes frontend-facing backend constraints, security guidance, and the OpenAPI source location, but backend executable specs, REST Docs, OpenAPI, and `README.md` remain higher-priority contract sources.
