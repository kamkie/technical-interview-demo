...
Use `ai/ARCHITECTURE.md` for placement and ownership. This file is about edit shape and repo-local coding conventions, not behavior authority.
...
- if placement or boundary questions appear, resolve them through `ai/ARCHITECTURE.md` instead of encoding architecture rules here
