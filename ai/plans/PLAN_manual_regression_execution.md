...
- Coordinator-owned files:
  - `ai/plans/PLAN_manual_regression_execution.md`
  - `ROADMAP.md`
...
- Downstream files that referenced `src/test/resources/http/` and were updated in the same change as the move:
  ...
  - any active `ai/plans/PLAN_*.md` that still cites the old path
...
- 2026-05-06 plan creation:
  ...
  - `./build.ps1 build` passed through the lightweight-file shortcut, reporting that only `ai/plans/PLAN_manual_regression_execution.md` and `ROADMAP.md` changed and that the Gradle build was skipped.
