...
- At planning time, `AGENTS.md`, `ai/DOCUMENTATION.md`, `ai/PLANNING.md`, and `ai/skills/repo-plan-author/SKILL.md` mentioned `ai/TASK_LIBRARY.md` as the reusable task catalog or task-title source.
