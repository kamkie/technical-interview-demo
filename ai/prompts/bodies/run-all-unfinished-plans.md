...
If any unfinished plans are too coupled for safe parallel execution, stop and explain why instead of forcing `Multi-Plan Fanout`.
Then execute the selected plan files in `Multi-Plan Fanout` mode using git worktrees.
