...
For `Single-Plan Fanout`, also note which shared files were intentionally left to the coordinator.
For `Multi-Plan Fanout`, also include the `CHANGELOG_<topic>.md` path.
