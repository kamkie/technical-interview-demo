...
- plan creation or material plan revision: update the concrete `ai/plans/PLAN_*.md` file and `ROADMAP.md` together so active work points to the plan path and current status
