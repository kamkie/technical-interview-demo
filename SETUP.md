...
5. Repeat the login flow and verify `GET /api/account` with the captured `technical-interview-demo-session` cookie. The convenience script at `src/manualTests/http/examples/authentication.http` shows the request shape.
