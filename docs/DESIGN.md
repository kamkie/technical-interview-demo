...
- `README.md`, `CONTRIBUTING.md`, `SETUP.md`, and `docs/LOCAL_DEVELOPMENT.md` own the project summary, contributor workflow, environment setup path, and local development workflows
