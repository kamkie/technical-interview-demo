...
| --- | --- | --- |
| Conceptualization | Capture a rough idea, TODO, maintenance signal, or user request. | [ROADMAP.md](../ROADMAP.md), [learning-rules.md](../.agents/references/learning-rules.md), [LEARNINGS.md](LEARNINGS.md) |
...
| Operations | Observe, triage, remediate, or schedule live signals. | [operations.md](../.agents/references/operations.md), [learning-rules.md](../.agents/references/learning-rules.md), [LEARNINGS.md](LEARNINGS.md) |
| Maintenance | Feed lessons and follow-up work into the next cycle. | [learning-rules.md](../.agents/references/learning-rules.md), [LEARNINGS.md](LEARNINGS.md), [ROADMAP.md](../ROADMAP.md) |
