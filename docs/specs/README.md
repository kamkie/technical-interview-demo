...
- [SPEC_admin-account-blocking.md](SPEC_admin-account-blocking.md) — admin block/unblock behavior for persisted user accounts, including sign-in and active-session rejection (Approved 2026-06-11)
