...
| Status | Workstream | Plan Or Artifact | Notes |
| --- | --- | --- | --- |
| Planned | Multi-agent roles, skills, and mode labels | `.agents/plans/PLAN_multi_agent_roles_and_skills.md`; `docs/decisions/0004-adopt-skill-first-multi-agent-workflow.md`; `docs/decisions/0003-adopt-multi-agent-roles-and-skill-catalog.md` | Plan is in `Needs Input`; mode labels are proposed as `M0: direct`, `M1: assisted`, `M2: delegated`, `M3: parallel`, and `M4: gated` while preserving identifiers and semantics. |
