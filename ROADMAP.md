...
#### Release Confidence
- [x] Execute `ai/PLAN_palantir_intellij_formatting.md` for `v2.0.0-RC5`, superseding archived `ai/archive/PLAN_ci_owned_spotless_reformat.md`. Plan lifecycle: `Implementation` / `In Progress`.
