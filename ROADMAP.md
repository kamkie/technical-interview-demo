...
| Status | Workstream | Plan Or Artifact | Notes |
| --- | --- | --- | --- |
| In Progress | Multi-agent roles, skills, and mode labels | `.agents/plans/PLAN_multi_agent_roles_and_skills.md`; `docs/decisions/0004-adopt-skill-first-multi-agent-workflow.md`; `docs/decisions/0003-adopt-multi-agent-roles-and-skill-catalog.md` | User accepted ADR 0004 as the principle decision and ADR 0003 as the implementation decision; plan execution is underway. |
